# -*- coding: utf-8 -*-
"""
Created on Wed Apr 22 07:40:01 2020
...
def solving(game_matrix):
    ...
    cost = calCost(game_matrix, g.getValue())
...
#        childs.clear()
        if n.getMatrix() == goal:
            ...
            if (recursion % 1000 == 0):
                print("#", end="")
            #Below statement is just to be sure that program is working and speed of program 
            #NOTE: it also slowdown the program abit
            print(recursion)
